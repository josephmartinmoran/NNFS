...
# # Now lets load a model and test the prediction functionality
# # Create dataset
...
# OpenCV uses BGR and matplotlib uses RBG
...
# resize image to be same resolution 28x28
image_data = cv2.resize(image_data, (28, 28))
# plt.imshow(image_data, cmap='gray')
# plt.show()

# Invert the greyscale so we have black background like training data
